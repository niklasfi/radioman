...
static int sock_cb(CURL *e, curl_socket_t s, int what, void *cbp, void *sockp)
{
  ...
  else
  {
    if(!actionp)
    {
      ...
      tcp_socket->assign(boost::asio::ip::tcp::v4(), s, ec);
      socket_map.insert(std::pair<curl_socket_t, boost::asio::ip::tcp::socket *>(s, tcp_socket));
...
int main(int argc, char **argv)
{
  ...
  //new_conn((char *)"http://1live.akacast.akamaistream.net/7/706/119434/v1/gnl.akacast.akamaistream.net/1live", &g);  /* add a URL */
  new_conn((char *)"http://google.com", &g);  /* add a URL */ 
